...
| ---------------- | -------------------------------------- | ------------------------------------------ | ------------------------------------------ |
| Skills website | Browse and discover skills resources | When looking for skill development tools | [https://skills.sh/](https://skills.sh/) |
...
| Meta-pattern recognition       | Identify recurring patterns across domains                                                                                 | When synthesizing multiple sources                                                                           | [./meta-skills/meta-pattern-recognition](./meta-skills/meta-pattern-recognition)             |
...
| Sequential thinking            | Dynamic and reflective problem-solving through adaptive thought processes that can evolve and revise as understanding deepens | When breaking down complex problems, planning with room for revision, or multi-step solutions needed       | [./meta-skills/sequential-thinking](./meta-skills/sequential-thinking)                       |
| Six Thinking Hats              | Structured parallel thinking process to separate different modes of thinking and ensure comprehensive perspective analysis | When making complex decisions, evaluating ideas thoroughly, or ensuring all viewpoints are considered      | [./meta-skills/six-thinking-hats](./meta-skills/six-thinking-hats)                           |
...
| Writing clearly and concisely  | Use when writing prose humans will read—documentation, commit messages, error messages, explanations, reports, or UI text | When writing documentation, commit messages, error messages, UI copy, reports, or any explanation for humans | [./meta-skills/writing-clearly-and-concisely](./meta-skills/writing-clearly-and-concisely)   |
...
| Six Thinking Hats           | Structured parallel thinking process to separate different modes of thinking and ensure comprehensive perspective analysis | When making complex product decisions, evaluating features thoroughly, or ensuring all stakeholder viewpoints are considered | [./productmanagement-skills/six-thinking-hats](./productmanagement-skills/six-thinking-hats) |
