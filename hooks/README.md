...
| protect-main-branch (PreToolUse) | Blocks `git commit` and `git push` when on main/master branch. Forces feature branch workflow. | Automatically on every Bash tool call (all projects) | `hooks/protect-main-branch/` |
